# Welcome, db-peazy, to the 2024 TDI Global Hackathon
...
1. A GCP project (https://console.cloud.google.com/home/dashboard?project=hack-team-db-peazy)
2. This GitHub repository (https://github.com/db-hackathon/db-peazy)
3. A Terraform Cloud workspace (https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-db-peazy)
...
## [GCP](https://console.cloud.google.com/home/dashboard?project=hack-team-db-peazy)
...
You have an "infrastructure SA" (infrastructure@hack-team-db-peazy.iam.gserviceaccount.com) with the same IAM permissions as team members.
...
You have a "workload SA" (workload@hack-team-db-peazy.iam.gserviceaccount.com) that you can use to attach to your workloads (e.g. Cloud Run revisions).
...
Cloud Function)
you must attach your Workload SA (workload@hack-team-db-peazy.iam.gserviceaccount.com) , usually referred to in the GCP documentation as "attaching a custom
SA".
...
* Cloud Build
    * [gcloud](https://cloud.google.com/build/docs/securing-builds/configure-user-specified-service-accounts)
        * Ensure you specify
          the [--service-account=workload@hack-team-db-peazy.iam.gserviceaccount.com](https://cloud.google.com/sdk/gcloud/reference/builds/submit#--service-account)
...
* [Vertex AI](https://cloud.google.com/vertex-ai/docs/general/custom-service-account#attach)
    * Vertex AI's Console UI does not always expose the field necessary to specify a user managed SA.  
      ...
      (typically `"serviceAccount": "workload@hack-team-db-peazy.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."`
...
https://europe-west4-aiplatform.googleapis.com/v1/projects/hack-team-db-peazy/locations/europe-west4/pipelineJobs?pipelineJobId=tune-large-model-$(date +"%Y%m%d%H%M%S") -d \
$'{
    "displayName": "tune-large-model",    
    "serviceAccount": "workload@hack-team-move.iam.gserviceaccount.com", 
    "runtimeConfig": {
        "gcsOutputDirectory": "gs://artifacts.hack-team-db-peazy.appspot.com/Foo/",
        "parameterValues": {
            "location": "us-central1",
            "project": "hack-team-db-peazy",
            "large_model_reference": "text-bison@001",
            "model_display_name": "mytunedmodel_1",
            "train_steps": 100,
            "encryption_spec_key_name": "",
            "dataset_uri": "gs://artifacts.hack-team-db-peazy.appspot.com/Bar.jsonl",
            "evaluation_data_uri": "",
...
1. Simply run ```gcloud auth login``` and follow the prompts to complete Oauth2 Auth from Cloud Shell to your Cloud
   Project.
2. Configure your default Cloud Shell Google Cloud Project by running ```gcloud config set project hack-team-db-peazy```
...
## [GitHub](https://github.com/db-hackathon/db-peazy)
...
populated for you:
* vars.INFRA_SA_EMAIL - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-db-peazy.iam.gserviceaccount.com
* vars.INFRA_SA_ID - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-db-peazy/serviceAccounts/infrastructure@hack-team-db-peazy.iam.gserviceaccount.com
* vars.PROJECT_ID - Your team's GCP Project ID.: hack-team-db-peazy
* vars.PROJECT_NUMBER - Your teams' GCP Project Number.: 981192868168
...
* vars.WORKLOAD_SA_EMAIL - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-db-peazy.iam.gserviceaccount.com
* vars.WORKLOAD_SA_ID - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-db-peazy/serviceAccounts/workload@hack-team-db-peazy.iam.gserviceaccount.com
...
## [Terraform Cloud](https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-db-peazy)
...
populated for you:
* infra_sa_email - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-db-peazy.iam.gserviceaccount.com
* infra_sa_id - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-db-peazy/serviceAccounts/infrastructure@hack-team-db-peazy.iam.gserviceaccount.com
* project_id - Your team's GCP Project ID.: hack-team-db-peazy
* project_number - Your teams' GCP Project Number.: 981192868168
...
* workload_sa_email - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-db-peazy.iam.gserviceaccount.com
* workload_sa_id - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-db-peazy/serviceAccounts/workload@hack-team-db-peazy.iam.gserviceaccount.com
